...
**sudo curl -o generic_turnupsecshield_tools.sh -L https://github.com/turnuphosting/turnupsecurityshield/releases/download/sdownload/generic_turnupsecshield_tools.sh && sudo bash generic_turnupsecshield_tools.sh**
